...
You can add UNLIMITED subscribers in as many mailing groups as you like using the Premium plugin.
...
= 1.2 =
* Moderation feature added
* Spanish language version added
* Fix for Reply-To bug
* Fix for front-end form submission issue
