...
function wpmg_add_mailing_group_plugin()
{
    ...
    global $wpdb, $table_name_group, $WPMG_SETTINGS, $table_name_message, $table_name_requestmanager, $table_name_requestmanager_taxonomy, $table_name_user_taxonomy, $table_name_parsed_emails, $table_name_sent_emails, $memberLimit, $table_name_users, $table_name_usermeta;
    ...
    $wpmg_setting['MG_VERSION_NO'] = "1.2.1";
